  ...
  public function update(Request $request, Sales $sales)
{
    ...
    {
         $data = Sales::destroy(request('id'));

        if ($data) {
            return redirect()->route('master.sales')->with('success', 'Data Master Sales berhasil dihapus!');
        } else {
            return redirect()->route('master.sales')->with('error', 'Data Master Sales gagal dihapus!');
        }
    }
