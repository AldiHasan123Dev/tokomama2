                    ...
                    if ($result[0]->transaksi->barang->status_ppn == 'ya'){
                        ...
                        foreach ($result as $item) {
                            Jurnal::create([
                                ...
                                'nomor' => $newNoJNL,
                                'tgl' => $tgl,
                                'keterangan' => 'Pendapatan ' . $item->transaksi->barang->nama . ' (' . number_format($item->jumlah, 0, ',', '.') . ' ' . $item->transaksi->satuan_jual . ' Harsat ' . number_format($item->transaksi->harga_jual, 0, ',', '.') . ')',
