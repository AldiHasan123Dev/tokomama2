...
.nilai_invoice {
    ...
    margin-bottom: 5px; /* Jarak bawah antar invoice */
}
    </style>
    ...
    <x-slot:script>
        ...
        <script>
            $(document).ready(function () {
                $("#table-lp").jqGrid({
                    ...
                    mtype: "GET",
                    colModel: [
                        { search: true, label: 'No', name: 'no', width: 30, align: "center", sortable: false }, // Kolom nomor urut
                        { search: true, label: 'Invoice', name: 'invoice', width: 100, align: "center", sortable: true },
                        { search: true, label: 'Nama Customer', name: 'customer', width: 120, align: "left", sortable: true }, // Kolom customer
                        ...
                        { search: true, label: 'Ditagih TGL', name: 'ditagih_tgl', width: 50, align: "center", formatter: 'date', formatoptions: { newformat: 'Y-m-d' }, sortable: true },
        ...
        return { "style": "background-color:red;color:white;" };
                    ...
                    loadComplete: function(data) {
                        ...
                        $("#table-lp").jqGrid('filterToolbar'); // Mengaktifkan filter toolbar setelah data dimuat
                    }
                });
...
$(document).ready(function () {
    $("#table-lp-total").jqGrid({
        ...
        mtype: "GET",
        colModel: [
            { label: 'No', name: 'no', width: 30, align: "center", sortable: false }, 
            { label: 'Bulan', name: 'bulan', width: 40, align: "center", sortable: true },
            { label: 'Jumlah Invoice', name: 'total_invoice', width: 40, align: "center", sortable: true },
            { label: 'Nilai Invoice', name: 'nilai_invoice', width: 120, align: "right", formatter: 'currency', formatoptions: { thousandsSeparator: ',' }, sortable: true },
            { label: 'Dibayar', name: 'telah_bayar', width: 120, align: "right", formatter: 'currency', formatoptions: { thousandsSeparator: ',' }, sortable: true },
            { label: 'Belum Dibayar', name: 'belum_dibayar', width: 120, align: "right", formatter: 'currency', formatoptions: { thousandsSeparator: ',' }, sortable: true },
        ],
